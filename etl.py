...
""" 	Below Function is used to Process all data files by finding the path of all data files. 
	func variable is used to direct song data to process_song_file function and process_log_file functions for log files."""
